    ...
    for person in people:
        ...
        if person in one_gene:
            ...
            if mother == None and father == None:
                ...
                #if mother passes it and father does not 
                ...
                #if father passes it and mother does not 
                if mother in one_gene:
                    gene_prob_2 = 0.5
                elif mother in two_genes:
                    gene_prob_2 = PROBS["mutation"]
                else:
                    gene_prob_2 = (1 - PROBS["mutation"])
                ...
                gene_prob = gene_prob + gene_prob_2
